...
<body>
  ...
  <div class="wrapper">
   ...
   <header id="header2"  class="fixed-top" >
         ...
         <nav class="navbar navbar-expand-lg navbar-dark py-3" id="navbar2" style="position:relative;" > 
      ...
      <div class="container" >
        ...
        <a class="navbar-brand" href="{{ route('home') }}"> <img src="/public/images/icons/logo3.png" alt="Icon logo"> </a> 
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class="col-md-3 text-end p-2 dropdown" id="budjes">
            ...
            <a href="{{ route('cart') }}"  class="icons-head" ><img src="/public/images/icons/shopping-bag.svg" height="24" width="24" alt="" ></a>
            ...
            @else
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                <a class="dropdown-item" href="#"  data-bs-toggle="modal" data-bs-target="#login">Войти</a>
                <a class="dropdown-item" href="#" data-bs-toggle="modal" data-bs-target="#register">Регистрация</a>
      ...
      <div class="p-4 ">
        ...
        <div  id="catalog-adaptation" style="display: none;">
          <ul class=" list-unstyled" id="pageSubmenu1">
              ...
              <a class="link-adaptation " aria-current="page" href="{{ route('about') }}">О нас</a>
            
           
              <a class="link-adaptation" href="{{ route('contact') }}">Контакты</a>
           
            
              <a class="link-adaptation " href="{{ route('news') }}">
                Новости
              </a> 
              @if (Auth::check())
              <a href="{{ route('cart') }}"  class="link-adaptation" ><img src="/public/images/icons/shopping-bag.svg" height="16" width="16" alt="" >Корзина</a>
              <a href="{{ route('logout') }}" class="link-adaptation">Выход</a>
              @else
           ...
           <li><a href="{{ route('catalog', ['id' => $c->id]) }}"><span class="fa fa-chevron-right mr-2"></span> {{ $c->name }}</a></li>
