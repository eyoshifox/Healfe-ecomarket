            ...
            <div class="row d-flex  justify-content-center mb-5">
                <div class="col-xxl-8 text-center p-3">
                        ...
                        <div class="breadcrumb justify-content-center">
                            ...
                            <li class="breadcrumb-item active" ><a href="{{ route('news') }}" id="breadcrumb-link">Новости</a></li>
                        </div>
                        <div class="breadcrumb-adaptiv2ver">
                          <li class="breadcrumb-item"><a href="{{ route('about') }}" id="breadcrumb-link">О нас</a></li>
                        </div>
