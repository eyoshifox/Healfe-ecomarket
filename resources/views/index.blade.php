    ...
    <div class="container text-center">
      <div class="row justify-content-center">
        ...
        <div id="seventh" class="buttonBox">
          <button><a href="{{ route('about') }}">Узнать подробнее</a> </button>
        </div>
    ...
    <div class="container  text-center">
     ...
     <div class="row justify-content-center text-center">
       <div class="swiper-popular">
         <div class="swiper-wrapper">
            @if ($swiper1 && !$swiper1->isEmpty())
            @foreach ($swiper1 as $s)
           <div class="swiper-slide">
            <a href="{{ route('item', ['id' => $s->id]) }}">  <div class="card">
               <div class="img-box">
                <img src="{{ $s->photo }}"  alt="">
                 
               </div>
               <a href="{{ route('item', ['id' => $s->id]) }}"><p class="content-title">{{ $s->name }}</p></a>
               <div class="content">
                
                 <span class="price">{{ $s->price }} ₽</span>
                 <span class="weight">{{ $s->weight }}г.</span>
               </div>
              
               <a href="{{ route('item', ['id' => $s->id]) }}" class="add-cart" type="button">Подробнее</a>
             </div> </a> <!--  end card-->
...
@endif
     ...
     <section class="promo" id="promo">
        ...
        <div class="row justify-content-center text-center">
         <div class="swiper-popular">
           <div class="swiper-wrapper">
            @if ($swiper2 && !$swiper2->isEmpty())
            @foreach ($swiper2 as $s)
             <div class="swiper-slide">
               <a href="{{ route('item', ['id' => $s->id]) }}">
               <div class="card">
                 <div class="img-hover">
                 <div class="img-box">
...
@endif
         ...
         <section class="promo" id="promo">
            ...
            <div class="row justify-content-center text-center">
             <div class="swiper-popular">
               <div class="swiper-wrapper">
                @if ($swiper3 && !$swiper3->isEmpty())
                @foreach ($swiper3 as $s)
                 <div class="swiper-slide">
                   <a href="{{ route('item', ['id' => $s->id]) }}">
                   <div class="card">
                     <div class="img-hover">
