<div class="modal fade" id="reg" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="<?php echo e(route('register')); ?>" id="regForm" onsubmit="ajaxForm(this, event)" method="POST">
          <?php echo csrf_field(); ?>
  ...
  <div class="modal fade" id="auth" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="auth">Modal title</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <form action="<?php echo e(route('auth')); ?>" id="authForm" onsubmit="ajaxForm(this, event)" method="POST">
          <?php echo csrf_field(); ?>
          <div class="modal-body">
            <div class="input-group has-validation mb-2">
              <input type="text" name="login" id="login" class="form-control" placeholder="Логин">
  ...
  </div><?php /**PATH C:\Users\Jojo\Desktop\OpenServer\domains\healfe\resources\views/include/modal.blade.php ENDPATH**/ ?>